...
const Offer = () => {
  return (
    <Container>
      <div className= "md:block bg-yellow-300 dark:bg-yellow-500 p-6 md:p-12 text-center space-y-6 rounded-lg">
        <h2 className="text-3xl md:text-4xl font-bold text-red-800 dark:text-red-600">
          Opening Offer
        </h2>
        <h1 className="text-5xl md:text-6xl font-bold text-slate-50 dark:text-orange-800">
